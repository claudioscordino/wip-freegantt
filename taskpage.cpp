...
//	QColor color = QColor::fromRgb(100, 100, 100);
//	painter.setPen(color);

	QBrush b (QColor::fromRgb(185, 211, 238));

	QRect* rect = new QRect (0, 0, 20, 800);
	taskScene->addRect(*rect, palette().foreground().color(), b);

	//QGraphicsTextItem t ()
	taskScene->addText("Hello, world!");
	//taskScene->setForegroundBrush(b);
